    ...
    return (
        <div className={`home-container ${isDarkMode ? 'dark' : ''}`}>
            <section className="intro-preview">
                ...
                <p>웹 개발과 디자인에 관심이 많은 학생입니다. 창의적인 솔루션을 통해 사용자 경험을 개선하는 것을 좋아합니다.</p>
                        ...
                        projects.map(project => (
                            <div className="project-card" key={project.id}>
                                ...
                                <div className="project-info">
                                    ...
                                    <Link to={project.link} target="_blank" rel="noopener noreferrer" className="view-button">View Project Link</Link>
                                </div>
                            </div>
                        ))
                    ) : (
